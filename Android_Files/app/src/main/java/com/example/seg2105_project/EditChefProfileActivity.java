    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent( EditChefProfileActivity.this, ChefActivity.class));
            }
        });
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(addChefSpecificInfoToDB(description,voidCheque)){
                    Toast.makeText(EditChefProfileActivity.this, "Updated successfully", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent( EditChefProfileActivity.this,ChefActivity.class));
                }else{
                    Toast.makeText(EditChefProfileActivity.this, "Failed to update", Toast.LENGTH_SHORT).show();
                }
